...
func startMockOrchestrator(reportCh chan string, doneCh chan interface{}, wg *sync.WaitGroup, m messenger.Messenger, logger *logrus.Logger) (chan interface{}, chan interface{}) {
	triggerOrchCh := make(chan interface{})
